                      ...
                      return (
                        <div key={e}>
                          <ListItem
                            primaryText={e}
                            rightIcon={<Checkbox
                              onCheck={self.updateCredit.bind(null, permissions.indexOf(e))}
                            />}
                          />
                          <Divider/>
                        </div>
                    ...
                    features.map(function (e) {
                      return (
                        <div key={e}>
                          <ListItem
                            primaryText={e}
                            style={(self.state.checkedFeatures.indexOf(features.indexOf(e)) === -1) ? {color: "lightgrey"} : {color: "black"}}
                            rightIcon={
                              <Checkbox
                              checked={self.state.checkedFeatures.indexOf(features.indexOf(e)) !== -1}
                              disabled={self.state.checkedFeatures.indexOf(features.indexOf(e)) === -1}
                            />}
                          />
                          <Divider/>
                        </div>
